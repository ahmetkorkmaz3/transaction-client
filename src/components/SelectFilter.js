...
export default function SelectFilter({ icon, options, onChangeHandler, selectedValue }) {
  return (
    <div className="relative inline-block w-64">
      ...
      <select className="block w-full bg-white border border-gray-300 text-black py-2 pl-12 pr-4 rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500" onChange={onChangeHandler}>
        {options.map((option) => (
